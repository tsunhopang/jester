...
"""
    ...
    doc += "    sample_masses: true              # Sample m1, m2 as parameters\n"
    ...
    doc += "    sample_masses: false                      # Include mass priors?\n"
    doc += "    m_min: 1.0                                # Min mass for marginalization (if not sampling)\n"
